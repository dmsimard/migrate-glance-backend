#!/usr/bin/env python
# Taken from https://github.com/openstack/python-openstackclient/blob/master/examples/common.py
#
...
CONSOLE_MESSAGE_FORMAT = '%(asctime)s - %(levelname)s: %(name)s %(message)s'
DEFAULT_VERBOSE_LEVEL = 1
USER_AGENT = 'migrate-glance-backend'

PARSER_DESCRIPTION = 'migrate-glance-backend'
